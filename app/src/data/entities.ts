...
export const entities: EntityConfig[] = [
  {
    ...
    fields: [
      ...
      { key: 'preco_inscricao', label: 'Preço Inscrição', type: 'number', required: true },
    ],
  },
  {
    key: 'participantes',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'data_hora', label: 'Data/Hora', type: 'datetime', required: true },
  ...
  },
  {
    ...
    endpoint: '/inscricoes',
    fields: [
      { key: 'id_participante', label: 'ID Participante', type: 'number', required: true },
      { key: 'id_evento', label: 'ID Evento', type: 'number', required: true },
      { key: 'data_inscricao', label: 'Data Inscrição', type: 'date', required: true },
      {
